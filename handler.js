...
const msg = {
  rowner: `❄️ *𝙍𝙪𝙠𝙞𝙖-𝘽𝙤𝙩 𝙍𝙚𝙨𝙩𝙧𝙞𝙘𝙘𝙞𝙤𝙣* ❄️\n» El comando *${comando}* solo puede ser usado por el *Shinigami Supremo* del sistema.`,

  owner: `🌙 *𝘼𝙘𝙘𝙚𝙨𝙤 𝙍𝙚𝙨𝙩𝙧𝙞𝙜𝙞𝙙𝙤* 🌙\n» El comando *${comando}* está reservado para el *Creador de Rukia-Bot*.`,

  mods: `🧊 *𝙈𝙤𝙙 𝙎𝙚𝙘𝙩𝙤𝙧* 🧊\n» Solo los *moderadores de confianza* pueden usar *${comando}*.`,

  premium: `💎 *𝙋𝙧𝙞𝙫𝙞𝙡𝙚𝙜𝙞𝙤 𝙋𝙧𝙚𝙢𝙞𝙪𝙢* 💎\n» El comando *${comando}* es exclusivo para *usuarios premium*.`,

  group: `👥 *𝙈𝙤𝙙𝙤 𝙂𝙧𝙪𝙥𝙤* 👥\n» El comando *${comando}* solo puede usarse en *grupos protegidos*.`,

  private: `🌌 *𝘾𝙝𝙖𝙩 𝙋𝙧𝙞𝙫𝙖𝙙𝙤* 🌌\n» El comando *${comando}* debe ser usado en *mensajes privados*.`,

  admin: `👑 *𝘼𝙙𝙢𝙞𝙣 𝙉𝙚𝙘𝙚𝙨𝙖𝙧𝙞𝙤* 👑\n» Solo *administradores del grupo* pueden usar *${comando}*.`,

  botAdmin: `⚔️ *𝙍𝙪𝙠𝙞𝙖-𝘽𝙤𝙩 𝙉𝙤 𝙀𝙨 𝘼𝙙𝙢𝙞𝙣* ⚔️\n» Para usar *${comando}*, necesito ser *administradora del grupo*.`,
