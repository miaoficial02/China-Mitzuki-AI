...
async function handler(conn, { message }) {
    const botPrefix = '.';
    const totalPlugins = 48; // Número total de plugins/comandos
...
┃ ❏ ${botPrefix}boobs • Ver boobs anime
┃ ❏ ${botPrefix}pussy • Ver pussy anime
┃ ❏ ${botPrefix}hentai • Ver hentai anime
┃ ❏ ${botPrefix}neko • Ver neko anime +18
┃ ❏ ${botPrefix}blowjob • Ver blowjob anime
╰━━━━━━━━━━⬣
...
┃ ❏ ${botPrefix}pat • Acariciar a alguien
┃ ❏ ${botPrefix}hug • Abrazar a alguien
┃ ❏ ${botPrefix}kiss • Besar a alguien
╰━━━━━━━━━━⬣
